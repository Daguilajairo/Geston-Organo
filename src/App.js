...
function App() {
  ...
  const [mostraLogin, setMostraLogin] = useState(false);  // Estado para controlar a exibição do login
  ...
  const handleLogout = () => {
    ...
    setMostraLogin(true);  // Mostra a tela de login
  };
